"""
Voting Classifier Tuning - Version 4

This script tunes a Voting Classifier that combines the best performing models:
- Random Forest (best F1: 0.6419) without class_weight
...
def main():
    print("\n" + "=" * 70)
    print("VOTING CLASSIFIER TUNING - VERSION 4")
    print("=" * 70)
    ...
    # Parameter grid
    param_grid = get_param_grid("voting", "v4")
    ...
    output_file = "results/voting_tuning_v4_results.csv"
    ...
    summary_file = "results/voting_tuning_v4_summary.csv"
