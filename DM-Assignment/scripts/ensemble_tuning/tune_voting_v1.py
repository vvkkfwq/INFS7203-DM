"""
Voting Classifier Tuning - Version 1
...
- Naïve Bayes (best F1: 0.3997)

Strategy:
- Try both hard and soft voting
- Test different weight combinations
- Use best hyperparameters from previous tuning
"""
...
def main():
    print("\n" + "=" * 70)
    print("VOTING CLASSIFIER TUNING - VERSION 1")
    print("=" * 70)
    print("\nCombining best models: RF (0.6419) + DT (0.6092) + NB (0.3997)")
    ...
    voting_clf = VotingClassifier(
        ...
        voting="soft",  # Default, will be tuned
        n_jobs=-1,
    )

    # Parameter grid
    param_grid = get_param_grid("voting", "v1")
    ...
    output_file = "results/voting_tuning_v1_results.csv"
    ...
    summary_file = "results/voting_tuning_v1_summary.csv"
