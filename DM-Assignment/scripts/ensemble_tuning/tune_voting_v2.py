"""
Voting Classifier Tuning - Version 2
...
def main():
    print("\n" + "=" * 70)
    print("VOTING CLASSIFIER TUNING - VERSION 2")
    print("=" * 70)
    ...
    # Parameter grid
    param_grid = get_param_grid("voting", "v2")
    ...
    output_file = "results/voting_tuning_v2_results.csv"
    ...
    summary_file = "results/voting_tuning_v2_summary.csv"
