"""
Voting Classifier Tuning - Version 5
...
def main():
    print("\n" + "=" * 70)
    print("VOTING CLASSIFIER TUNING - VERSION 5")
    print("=" * 70)
    ...
    # Parameter grid
    param_grid = get_param_grid("voting", "v5")
    ...
    output_file = "results/voting_tuning_v5_results.csv"
    ...
    summary_file = "results/voting_tuning_v5_summary.csv"
