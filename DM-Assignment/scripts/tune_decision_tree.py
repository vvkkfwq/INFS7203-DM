"""
Decision Tree hyperparameter tuning script.

This script performs GridSearchCV to find optimal hyperparameters for Decision Tree
...
def save_results(results, output_file="results/decision_tree_tuning_results.csv"):
    """
...
def main():
    ...
    try:
        ...
        print(
            f"  2. Compare with Random Forest tuning results"
        )
