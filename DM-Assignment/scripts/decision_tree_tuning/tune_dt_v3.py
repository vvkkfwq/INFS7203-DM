"""
Decision Tree hyperparameter tuning - Version 3: Change param_grid to focus on specific values

Experiment Goal: Refine hyperparameter search space based on v1 results

Changes from v1:
- Adjusted max_depth range to [5, 10, 15] based on v1 results
- Adjusted min_samples_split to [20, 30, 40]
- Adjusted min_samples_leaf to [2, 4, 6]
- Removed max_features options to only use None

Baseline: F1=0.6039 (v1)
"""
...
def save_results(results, output_file="results/decision_tree_v3_tuning_results.csv"):
    """
